...
def getImage(line, correction, which):
    if (which=='right'):
        src_path=line[2]
...
count=0
for line in lines:
    image,steering=getImage(line, 0.05, 'left')
    images.append(image)
    image_flipped=np.fliplr(image)
    images.append(image_flipped)
    measurements.append(steering)
    measurements.append(-steering)
    image,steering=getImage(line, 0.05, 'center')
    images.append(image)
    image_flipped=np.fliplr(image)
    images.append(image_flipped)
    measurements.append(steering)
    measurements.append(-steering)
    image,steering=getImage(line, 0.05, 'right')
    images.append(image)
    image_flipped=np.fliplr(image)
    images.append(image_flipped)
    measurements.append(steering)
